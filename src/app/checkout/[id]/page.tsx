  ...
  <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
    <div className="max-w-5xl mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">Revisa tu pedido y completa la información de pago</p>
      </div>
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-2xl shadow-sm border p-6">
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-600 mb-3">Cantidad: <span className="font-medium text-gray-900">{quantity} unidades</span></p>
          ...
          <div className="bg-white rounded-2xl shadow-sm border p-6">
            ...
            <p className="text-sm text-gray-500 mt-2">¿Tienes un cupón? Ingrésalo para obtener descuentos adicionales</p>
          </div>
              ...
              <label className={`relative cursor-pointer p-4 rounded-xl border-2 transition-all ${
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Débito/Crédito</p>
                  </div>
                </div>
              </label>
            </div>
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-2xl shadow-sm border p-6 sticky top-8">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white font-semibold py-4 rounded-xl transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98] shadow-lg hover:shadow-xl flex items-center justify-center"
            >
